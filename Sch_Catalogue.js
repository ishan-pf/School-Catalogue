...
class MiddleSchool extends School{
   ...
   get averageTestScores(){
     return this._averagrTestScores;
   }
};
...
class SchoolCatalog{
  constructor(nameOfSchools,level,numberOfSchools){
    this._nameOfSchools = numberOfSchools;
    this._level = level;
    this._numberOfSchools = numberOfSchools;
  }
  get nameOfSchools(){
    return this._nameOfSchools;
  }
  get level(){
    return this._level;
  }
  get numberOfSchools(){
    return this._numberOfSchools;
  }
